...
if (isset($_POST['loginbtn'])) {
    ...
    // Query the database
    $sql = "SELECT email, pass FROM signuppage WHERE email='$email' AND pass='$pass'" ;
    $res = $conn->query($sql);

    // Check if query execution is successful and returns rows
    if ($row=$res->fetch_assoc()) {
        // Valid user, redirect to user dashboard
        header("Location: http://localhost/MyJay/Userdash.php");
        exit();
        ...
        $_SESSION['role'] = 'admin';
        header("Location: http://localhost/MyJay/Admindash.php");
        exit();

    } else {
        // Invalid login, redirect to login page
        header("Location: http://localhost/MyJay/Login.php");
        exit();
    }
}
...
<link rel="icon" href="photos/Daliy.gif">
  <title>DailyWander: Explore a New World Every Day</title>
</head>
<body>
...
<div class="dust-paarticle" style="margin-top:3rem;">
        ...
        <div class="brand-col">
          <div class="headline">
            ...
            <div class="brand-logo">
              <img src="photos/Daliy.gif" width="150" alt="brand-logo" style="border-radius:40%;">
            </div><!-- ./brand-logo -->
            <p>Adventure Awaits. Go find it! One with the clouds. Havana good time in Cuba. People don't take trips, trips take people</p>
        ...
        <div class="authfy-login">
          ...
          <div class="authfy-panel panel-login text-center active">
            <div class="authfy-heading">
              ...
              <p>Don’t have an account? <a class="lnk-toggler" data-panel=".panel-signup" href="Signup.php">Sign Up Free!</a></p>
            </div>
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                <form name="loginForm" class="loginForm" action="#" method="POST">
                  ...
                  <div class="row remember-row">
                    ...
                    <div class="col-xs-6 col-sm-6">
                      <p class="forgotPwd">
                        <a class="lnk-toggler" data-panel=".panel-forgot" href="Forgetverfication.php">Forgot password?</a>
                      </p>
                    </div>
                  </div> <!-- ./remember-row -->
                  <div class="form-group">
                    <input type="submit" name="loginbtn" value="Login" class="btn btn-lg btn-primary" onclick="login()">
...
<script>
// Animate the SVG element with ID 'XMLID5'
var design = anime({
  targets: 'svg #XMLID5',
  keyframes: [
    { translateX: -500 },
...
// Animate the paths inside the element with ID 'dust-paarticle'
anime({
